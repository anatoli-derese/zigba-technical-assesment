...
// in Demoz/test/company_repository_test.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i4;

import 'package:Demoz/Models/Company.dart' as _i5;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCompanyBox extends _i1.Mock implements _i2.Box<_i5.Company> {
  MockCompanyBox() {
    _i1.throwOnMissingStub(this);
  }

  @override
  Iterable<_i5.Company> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i5.Company>[],
      ) as Iterable<_i5.Company>);
  ...
  @override
  Iterable<_i5.Company> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Company? getAt(int? index) => (super.noSuchMethod(Invocation.method(
        #getAt,
        [index],
      )) as _i5.Company?);

  @override
  Map<dynamic, _i5.Company> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i5.Company>{},
      ) as Map<dynamic, _i5.Company>);
  ...
  @override
  _i4.Future<void> putAll(Map<dynamic, _i5.Company>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i4.Future<int> add(_i5.Company? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i4.Future<Iterable<int>> addAll(Iterable<_i5.Company>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
